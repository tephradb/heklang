...
pub use ir::{
    ...
    Filter, FoldSubject, Function, Handler, Ident, Index, Iter, Literal, Number, NumberError,
    Param, Program, Projector, RecordDef, RecordField, Return, Slice, SliceId, Slot, Span,
