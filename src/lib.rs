...
pub use ir::{
    ...
    Filter, Function, Guard, GuardCall, Handler, Ident, Index, Iter, Literal, Number, NumberError,
    Param, Pos, Program, Projector, RecordDef, RecordField, Return, Slice, SliceId, Slot, Span,
